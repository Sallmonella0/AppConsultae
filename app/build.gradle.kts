...
dependencies {
    ...
    // Para fazer chamadas de rede (o equivalente ao 'requests' em Python)
    implementation("com.squareup.retrofit2:retrofit:2.9.0")
    implementation("com.squareup.retrofit2:converter-gson:2.9.0") // Converte a resposta JSON para objetos Kotlin
